...
# Задача 4: Создайте новую базу данных на сайте timeweb, создайте таблицу "туры", которая будет хранить информацию о турах турфирмы. Таблица должна содержать следующие столбцы:
...
# Задача 5: Наполнить таблицу данными.
